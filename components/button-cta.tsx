...
export default function ButtonCta({
  ...
  return (
    <button
      className={cn(`relative inline-flex items-center justify-center rounded-xl font-medium transition-all duration-300 ease-out ${variants[variant]}
                ${sizes[size]}disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none ${className}
            `)}
      {...props}
    >
      {children}
